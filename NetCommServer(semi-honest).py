...
class ThreadedServer(socketserver.ThreadingMixIn, socketserver.TCPServer):
    def __init__(self, id, num_clients, offline, generate, dimension, upperbound, address, handler_class):
        ...
        if self.id == 1:
            ...
            if self.id == 2:
                ...
                self.filename_sigma_shares23 = ''
                self.filename_sigma_shares13 = ''
        self.filename_epsilon_shares = ''
        # if self.generate > 0:
        #     self.is_component_wise_bounding_done = True
        #     # set filenames
        #     if self.id == 1:
        #         self.filename_betas = './randomness/'+'server1'+'_betas'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #         self.filename_beta_shares12 = './randomness/'+'server1'+'_beta_shares12'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #         self.filename_beta_shares13 = './randomness/'+'server1'+'_beta_shares13'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #         self.filename_sigma_shares12 = './randomness/'+'server1'+'_sigma_shares12'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #         self.filename_sigma_shares13 = './randomness/'+'server1'+'_sigma_shares13'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #     else:
        #         self.filename_alphas = './randomness/'+'server'+str(self.id)+'_alphas'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #         if self.id == 2:
        #             self.filename_beta_shares12 = './randomness/'+'server2'+'_beta_shares12'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #             self.filename_beta_shares23 = './randomness/'+'server2'+'_beta_shares23'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #             self.filename_sigma_shares12 = './randomness/'+'server2'+'_sigma_shares12'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #             self.filename_sigma_shares23 = './randomness/'+'server2'+'_sigma_shares23'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #         else:
        #             self.filename_beta_shares23 = './randomness/'+'server3'+'_beta_shares23'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #             self.filename_beta_shares13 = './randomness/'+'server3'+'_beta_shares13'+'_clients'+ str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #             self.filename_sigma_shares23 = './randomness/'+'server3'+'_sigma_shares23'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #             self.filename_sigma_shares13 = './randomness/'+'server3'+'_sigma_shares13'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
        #     self.filename_epsilon_shares = './randomness/'+'server'+str(self.id)+'_epsilons'+'_clients'+str(self.num_clients)+'_dimension'+str(self.data_dimension)+'_ring'+str(self.ring_size)+'.bin'
    ...
    def serve_forever(self):
        ...
        while True:
            ...
            if self.is_multiplication_done == True and self.is_receive_multiplication_share_done == True:
                ...
                file_epsilon_shares = open(self.filename_epsilon_shares, 'w+b')
                
                for client_id in self.yis_in_multiplication_protocol.keys():
                    for i in range(self.data_dimension):
                        for j in range(self.ring_size):
                            if self.id == 1:
                                file_epsilon_shares.write(self.yis_in_multiplication_protocol[client_id][i][j].to_bytes(self.num_bytes,sys.byteorder))
                                file_epsilon_shares.write(self.received_yis_in_multiplication_protocol[client_id][i][j].to_bytes(self.num_bytes,sys.byteorder))
                                # self.logger.debug('client: %s, dimension: %s, index: %s, correct epsilon12: %s, epsilon13: %s',client_id,i+1,j+1,self.yis_in_multiplication_protocol[client_id][i][j],self.received_yis_in_multiplication_protocol[client_id][i][j])
                            else:
                                file_epsilon_shares.write(self.received_yis_in_multiplication_protocol[client_id][i][j].to_bytes(self.num_bytes, sys.byteorder))
                                file_epsilon_shares.write(self.yis_in_multiplication_protocol[client_id][i][j].to_bytes(self.num_bytes,sys.byteorder))
                                # self.logger.debug('client: %s, dimension: %s, index: %s, correct epsilon1: %s, epsilon2: %s',client_id,i+1,j+1,self.received_yis_in_multiplication_protocol[client_id][i][j],self.yis_in_multiplication_protocol[client_id][i][j])
            ...
            if self.is_ready_for_share_conversion_phase2 == True:
                ...
                file_epsilon_shares = open(self.filename_epsilon_shares,'r+b')
                start = time.perf_counter()
                for client_id in self.deltas.keys():
                    ...
                    for i in range(self.data_dimension):
                        ...
                        for j in range(self.ring_size):
                            if self.id == 1:
                                epsilon12 = int.from_bytes(file_epsilon_shares.read(self.num_bytes),sys.byteorder)
                                ...
                                epsilon13 = int.from_bytes(file_epsilon_shares.read(self.num_bytes),sys.byteorder)
                                ...
                                self.final_converted_arithmetic_shares[client_id][i][0] = (self.final_converted_arithmetic_shares[client_id][i][0] + \
                                                                                        pow(2,j) * (pow(-1,self.deltas[client_id][i][j]) * epsilon12)) & self.mask
                                epsilon23 = int.from_bytes(file_epsilon_shares.read(self.num_bytes),sys.byteorder)
                                self.final_converted_arithmetic_shares[client_id][i][1] = (self.final_converted_arithmetic_shares[client_id][i][1] + \
    ...
    def generate_correlated_tuples(self):
        ...
        if self.id == 1:
            ...
            # file_beta_shares13.seek(0) # move the file pointer to the beginning
    ...
    def semihonest_multiplication_batch(self):
        ...
        if self.id == 1:
            ...
            for client_id in self.yis_in_multiplication_protocol.keys():
                ...
                for i in range(self.data_dimension):
                    for j in range(self.ring_size):
                        socket_obj.send(self.yis_in_multiplication_protocol[client_id][i][j].to_bytes(self.num_bytes, sys.byteorder))
        elif self.id == 2:
            s3_address = ('localhost',self.peers['3'])
            # socket_obj.connect(s3_address)
            while True:
    ...
    def handle(self):
        ...
        if request.decode() == 'CLIENT-DATAUPLOADING': 
            ...
            if self.server.num_clients_data_received == self.server.num_clients:
                ...
                # set filenames
                if self.server.id == 1:
                    self.server.filename_betas = './randomness/'+'server1'+'_betas'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                    self.server.filename_beta_shares12 = './randomness/'+'server1'+'_beta_shares12'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                    self.server.filename_beta_shares13 = './randomness/'+'server1'+'_beta_shares13'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                    self.server.filename_sigma_shares12 = './randomness/'+'server1'+'_sigma_shares12'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                    self.server.filename_sigma_shares13 = './randomness/'+'server1'+'_sigma_shares13'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                else:
                    self.server.filename_alphas = './randomness/'+'server'+str(self.server.id)+'_alphas'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                    if self.server.id == 2:
                        self.server.filename_beta_shares12 = './randomness/'+'server2'+'_beta_shares12'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                        self.server.filename_beta_shares23 = './randomness/'+'server2'+'_beta_shares23'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                        self.server.filename_sigma_shares12 = './randomness/'+'server2'+'_sigma_shares12'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                        self.server.filename_sigma_shares23 = './randomness/'+'server2'+'_sigma_shares23'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                    else:
                        self.server.filename_beta_shares23 = './randomness/'+'server3'+'_beta_shares23'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                        self.server.filename_beta_shares13 = './randomness/'+'server3'+'_beta_shares13'+'_clients'+ str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                        self.server.filename_sigma_shares23 = './randomness/'+'server3'+'_sigma_shares23'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                        self.server.filename_sigma_shares13 = './randomness/'+'server3'+'_sigma_shares13'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
                self.server.filename_epsilon_shares = './randomness/'+'server'+str(self.server.id)+'_epsilons'+'_clients'+str(self.server.num_clients)+'_dimension'+str(self.server.data_dimension)+'_ring'+str(self.server.ring_size)+'.bin'
